...
WebUI.waitForElementPresent(findTestObject('AccountPage_login/LoginSection/span_Zadejte e-mailovou adresu'), 2)

WebUI.verifyElementText(findTestObject('AccountPage_login/LoginSection/span_Zadejte e-mailovou adresu'), 'Zadejte e-mailovou adresu')
